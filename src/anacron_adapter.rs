...
const fn malformed() -> AnacronTableState {
    AnacronTableState::Unknown(UnavailableReason::MalformedEvidence)
}
...
fn timestamp_state(
    ...
    match matches.as_slice() {
        ...
        _ => AnacronTimestampState::Unknown(UnavailableReason::MalformedEvidence),
    }
}
...
fn bounded_timestamp(
    ...
    match parse_date(bytes) {
        ...
        Err(reason) => AnacronTimestampState::Unknown(reason),
    }
}
